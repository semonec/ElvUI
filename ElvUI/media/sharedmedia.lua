...
LSM:Register("font", "MD_Best", [[Interface\AddOns\ElvUI\media\fonts\MDEUDDUM.ttf]]);
LSM:Register("font", "Seoul NamSan B", [[Interface\AddOns\ElvUI\media\fonts\SeoulNamSanB.ttf]]);
